...
void main(){gl_Position=position;}`;
  ...
  // Default to site amber: #E38B29 → (227/255, 139/255, 41/255)
  private color: [number, number, number] = [0.89, 0.545, 0.161];
...
interface SmokeBackgroundProps {
  /** Hex color for the smoke tint. Defaults to the site amber (#E38B29). */
  smokeColor?: string;
}
...
export const SmokeBackground: React.FC<SmokeBackgroundProps> = ({
  ...
  // Initialise WebGL renderer once on mount
  useEffect(() => {
  ...
  // Update tint color whenever the prop changes
  useEffect(() => {
